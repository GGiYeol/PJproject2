        ...
        <form method="post">
          <div class="form-group">
            ...
            <div class="input-group">
              <input type="text" class="form-control" id="input1" required name="id" value="${comFreeMember.id }">
          ...
          <div class="form-group">
            ...
            <input type="password" class="form-control" id="input2" required name="password" value="${comFreeMember.password }">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              <input type="text" class="form-control" id="input5" required name="nickName" value="${comFreeMember.nickName }">
          ...
          <div class="form-group">
            ...
            <input type="email" class="form-control" id="input3" required name="email" value="${comFreeMember.email }">
          </div>
          <div class="form-group">
            <label for="input4">주소</label>
            <input type="text" class="form-control" id="input4" required name="address" value="${comFreeMember.address }">
          </div>
